      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          <h1 className="text-5xl font-extrabold text-gray-900 mb-6">
            About Amone Intelligence
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            We help businesses nurture customers into live phone calls — automatically. Amone Intelligence uses intelligent SMS outreach to build relationships and get your phone ringing with people who are ready to talk.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white rounded-xl shadow-lg p-8 md:p-12">
          ...
          <p className="text-lg text-gray-600 mb-4">
            Amone Intelligence was built to solve one of the biggest problems in business: customers who show interest but never follow through. Every day, businesses lose revenue because prospects fill out a form or visit a page — and then disappear.
          </p>
          ...
          <p className="text-lg text-gray-600 mb-4">
            Amone Intelligence provides an automated SMS-to-call platform that helps businesses nurture customers and convert interest into live phone conversations. Our service includes:
          </p>
          ...
          <p className="text-lg text-gray-600 mb-4">
            Phone calls close deals. Studies show that customers contacted by phone are 8x more likely to convert than those reached by email alone. Amone Intelligence bridges the gap — using SMS to nurture your customers and get them on the phone, where your team can build relationships and close deals. We're dedicated to helping you maximize inbound call volume through intelligent, automated outreach.
          </p>
